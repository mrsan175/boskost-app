...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div
        className="pointer-events-none absolute -right-32 -top-32 h-125 w-125 animate-pulse rounded-full opacity-40 blur-3xl mix-blend-multiply"
        style={{
          background:
      ...
      />
      <div
        className="pointer-events-none absolute -bottom-32 -left-32 h-150 w-150 animate-pulse rounded-full opacity-30 blur-3xl mix-blend-multiply"
        style={{
          background:
            "radial-gradient(circle, rgba(217,119,6,0.2) 0%, transparent 60%)",
      ...
      <div
        className="pointer-events-none absolute left-1/3 top-1/2 h-75 w-75 -translate-x-1/2 -translate-y-1/2 rounded-full border opacity-5 animate-spin-slow"
        style={{ borderColor: "var(--primary)", borderWidth: "2px" }}
      />
      <div
        className="pointer-events-none absolute left-1/3 top-1/2 h-125 w-125 -translate-x-1/2 -translate-y-1/2 rounded-full border opacity-5 animate-spin-slow"
        style={{
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-6 py-10 lg:grid-cols-2">
        ...
        <div className="animate-fade-up">
          ...
          >
            Solusi Cerdas <br className="hidden md:block" />
            <span
          ...
          >
            Kelola kamar, penyewa, dan laporan keuangan dalam satu dashboard
            yang mudah digunakan. Tingkatkan efisiensi properti Anda hari ini.
          </p>
        ...
        <div className="relative delay-300 animate-fade-up">
          ...
          >
            ...
            <div
              className="group relative mb-4 h-75 w-full overflow-hidden rounded-xl lg:h-80"
              style={{
                background: "var(--surface-container-high)",
